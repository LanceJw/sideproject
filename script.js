...
let questionSelector5 = document.getElementById('questionSelector5');
let answerDiv5 = document.getElementById('answerDiv5');
answerDiv5.style.display = 'none'

const revealAnswerHandler5 = () => {

    if (answerDiv5.style.display == 'none') {
        answerDiv5.style.display = 'flex';
    } else {
        answerDiv5.style.display = 'none';
    }
}

questionSelector5.addEventListener('click', revealAnswerHandler5)
...
//         content.classList.add("mobile_content");
//         content.classList.remove("content_container");
//         section.classList.add("mobile_section");
//         section.classList.remove("individual_section");
//     } else {
//         content.classList.remove("mobile_content");
//         content.classList.add("content_container");
//         section.classList.remove("mobile_section");
//         section.classList.add("individual_section");
//     }
// })
...
const toggleNavbar = () => {
    const NavbarMenu = document.getElementById("mobile_navbarMenu");
